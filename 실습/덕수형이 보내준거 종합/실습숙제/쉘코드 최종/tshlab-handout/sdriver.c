...
int main(int argc, char **argv)
{
    ...
    sprintf(test_raw_outfile, 
	    "/usr/tmp/test_raw_outfile.%d", getpid());
    sprintf(ref_raw_outfile, 
	    "/usr/tmp/ref_raw_outfile.%d", getpid());
    sprintf(diff_raw_outfile, 
	    "/usr/tmp/diff_raw_outfile.%d", getpid());

    sprintf(test_filtered_outfile, 
	    "/usr/tmp/test_filtered_outfile.%d", getpid());
    sprintf(ref_filtered_outfile, 
	    "/usr/tmp/ref_filtered_outfile.%d", getpid());
    sprintf(diff_filtered_outfile, 
	    "/usr/tmp/diff_filtered_outfile.%d", getpid());
